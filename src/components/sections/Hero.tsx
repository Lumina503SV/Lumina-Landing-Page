  ...
  return (
    ...
    >
      ...
      <div className="relative mx-auto max-w-6xl px-6 py-24 text-center lg:px-8 lg:py-32">
        ...
        <p className="lumina-rise mx-auto mt-6 max-w-xl text-lg text-body">
          Convertimos los procesos manuales de tu negocio en sistemas, apps y
          plataformas hechas a tu medida. Diseñadas y desarrolladas en El
          Salvador.
        </p>
